...
CREATE TABLE `libros` (
  ...
  PRIMARY KEY (`LibroID`),
  KEY `AutorID` (`AutorID`),
  CONSTRAINT `libros_ibfk_1` FOREIGN KEY (`AutorID`) REFERENCES `autor` (`AutorID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ventas` (
  ...
  KEY `LibroID` (`LibroID`),
  CONSTRAINT `ventas_ibfk_1` FOREIGN KEY (`ClienteID`) REFERENCES `cliente` (`ClienteID`),
...
-- Dump completed on 2025-05-06 17:37:10
